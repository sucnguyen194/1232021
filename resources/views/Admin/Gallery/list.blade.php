                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-0">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.gallerys.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.pages.delMulti')}}" enctype="multipart/form-data">
                        ...
                        <div class="action-datatable mb-3">
                            ...
                            <a href="{{route('admin.gallerys.create')}}" class="btn btn-primary waves-effect width-md waves-light float-right">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            @foreach($gallery as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.gallerys.edit',$item)}}" class="btn btn-default waves-effect waves-light">

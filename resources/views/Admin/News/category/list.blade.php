                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-0">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.news_category.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    ...
                    <div class="action-datatable mb-3">
                        ...
                        <a href="{{route('admin.news_category.create')}}" class="btn btn-primary waves-effect width-md waves-light float-right">

                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-2">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.news.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.news.delMulti')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="action-datatable mb-3">
                            <button class="btn btn-default border-primary text-primary waves-effect waves-light" onclick="return confirm('Bạn chắc chắn muốn xóa!')" type="submit" name="delall" value="delete"> Xóa tất cả</button>

                            <a href="{{route('admin.news.create')}}" class="btn btn-primary waves-effect width-md waves-light float-right">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            <tr>
                                <th>
                                    <div class="checkbox">
                                        <input id="check-all" class="check_del" {{$news->count() == 0 ? "disabled" : "" }} type="checkbox" name="checkAll">
                            ...
                            @foreach($news as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.news.edit',$item)}}" class="btn btn-default waves-effect waves-light">
                                                <span class="icon-button"><i class="fe-edit-2"></i></span></a>

                                            <a href="{{route('admin.news.del',$item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa?');" class="btn btn-default waves-effect waves-light">

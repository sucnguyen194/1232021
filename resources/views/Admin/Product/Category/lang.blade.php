    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.news_category.index')}}">Danh mục sản phẩm</a></li>
                            <li class="breadcrumb-item active">Thêm mới</li>

                        </ol>
                    </div>
                    <h4 class="page-title">{{$cate->name}} <small>({{$lang}})</small> </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <form method="post" action="" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card-box">
                        <label class="font-weight-bold mb-2">Keyword seo</label>

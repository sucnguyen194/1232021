                ...
                <div class="col-lg-8">
                    <div class="card-box">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{old('title')}}" id="title" onkeyup="ChangeToSlug();" name="data[name]" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control alias" id="alias" value="{{$news_category->alias ?? old('alias')}}" name="data[alias]" required>
                        </div>

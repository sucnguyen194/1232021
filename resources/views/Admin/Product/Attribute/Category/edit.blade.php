...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.attribute_categorys.index')}}">Danh mục bộ lọc</a></li>
    ...
    <div class="container">
        <form method="post" action="{{route('admin.attribute_categorys.update',$attribute_category)}}" enctype="multipart/form-data">
            <div class="row">
                @csrf
                @method('PUT')
                <div class="col-lg-12">

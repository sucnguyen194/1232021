      ...
      <form class="form-horizontal form-label-left tform" method="post" enctype="multipart/form-data">
            ...
            <div class="x_content">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <input id="name" class="form-control col-md-7 col-xs-12 input" data-validate-length-range="6" data-validate-words="2" name="title" required="required" type="text" value="{{old('title')}}">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <select id="parent_id" name="parent_id" class="form-control">
                    ...
                    {{Helper::sub_add_cate($cate_recruitment,$items->id)}}
                    @endif
                    @endforeach
                  </select>
                </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <input id="alias" class="form-control col-md-7 col-xs-1" name="text" type="text" value="{{old('text')}}">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <input id="alias" class="form-control col-md-7 col-xs-12" name="slogan" type="text" value="{{old('slogan')}}">
                </div>
              </div>
              <div class="item form-group">
        ...
        <div class="col-md-4 col-xs-12">
          ...
          <div class="hidden-lg hidden-sm hidden-md">
            <div class="ln_solid"></div>
            <div class="text-center">
              <a href="{{url('admin/list-news-category')}}" class="btn btn-primary"><span class="icon-button"><i class="fa fa-undo" aria-hidden="true"></i></span> Quay lại</a>
              <button id="submit" name="submit" type="submit" class="btn btn-success"/><span class="icon-button"><i class="fa fa-floppy-o" aria-hidden="true"></i></span> Lưu lại </button>
            </div>
          </div>
        </div>

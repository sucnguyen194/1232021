                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-purple waves-effect waves-light" href="{{route('admin.support.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.support.delMulti')}}" enctype="multipart/form-data">
                        ...
                        <div class="action-datatable mb-3">
                            <a href="{{route('admin.support.create')}}" class="btn btn-primary waves-effect width-md waves-light">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-striped table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            @foreach($support as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.support.edit',$item)}}" class="btn btn-purple waves-effect waves-light">
                                            <span class="icon-button"><i class="fe-edit-2"></i></span></a>

                                        <a href="{{route('admin.support.del',$item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa?');" class="btn btn-warning waves-effect waves-light">

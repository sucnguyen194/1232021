                                ...
                                <div class="col-md-8">
                                    <div class="card-box">
                                        <div class="form-group">
                                            <label for="name" class="font-weight-bold">Tên nhân viên <span class="required">*</span></label>
                                            <input type="text" class="form-control" name="name" id="name" value="{{old('name')}}" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="description" class="font-weight-bold">Lời nhắn <span class="required">*</span></label>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4 offset-md-4">
                                    <div class="card-box">
                                        ...
                                        <div class="form-group">
                                            <label for="job" class="font-weight-bold">Chức vụ</label>
